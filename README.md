...
In this way, our model only retreieve 20 destinations, select the best one and fill-in the midway trajectories **deterministically** (This is really not our point but more comparable).
